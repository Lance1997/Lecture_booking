...
<?php
 ...
 ?>
    ...
    <div class="alert alert-warning">
      <?php echo "Please Inform Course Rep to verify email in order to login after creating course Rep. A default generated password will also be included in the email."; ?>
    </div>
